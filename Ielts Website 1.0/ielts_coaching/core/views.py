...
from .serializers import RecordedClassSerializer, StudyMaterialSerializer, MockAssignmentSerializer, SubmissionSerializer, UserSerializer, CourseSerializer, StudentCourseSerializer, CourseBundleSerializer
from rest_framework.views import APIView
from rest_framework.permissions import IsAuthenticated
...
class CourseRoadmapView(APIView):
    ...
    def get(self, request, course_id):
        bundles = CourseBundle.objects.filter(course_id=course_id)
