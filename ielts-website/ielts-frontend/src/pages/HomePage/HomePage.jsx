...
function HomePage() {
  ...
  return (
    <div className="relative min-h-screen bg-white overflow-x-hidden">
      ...
      {/* Main Content */}
      <div className="bg-brandCream mt-5 px-4 sm:px-6 md:px-10">
        <HeaderText />
      </div>
      ...
      <div className="courseDiv px-4 sm:px-6 md:px-10 py-8">
        <p className="text-brandRed text-3xl sm:text-4xl md:text-5xl font-extrabold text-center sm:text-right mb-6">
          Our Courses
        </p>
        ...
        <TextContainer
          type="cream"
          text="We provide multiple courses that will help you get ready for IELTS. The courses are integrated with AI to help you analyze yourself with the updated technology. Our IELTS course is designed to help you master all four essential skills — Speaking, Listening, Reading, and Writing."
          styleClass="my-6 text-sm sm:text-base md:text-lg"
        />
        ...
        <div className="mt-10 flex justify-center">
          <Link to="/course-roadmap/3">
            <button className="bg-brandRed text-white px-6 py-3 rounded-xl text-base sm:text-lg hover:bg-red-700 transition-all">
              Try Demo Course
            </button>
          </Link>
        </div>
